<template>
  <section class="all-sections">
    ...
    <grid-component :partialPath="'artists'" :objList="allArtists" />
  </section>
</template>
...
export default {
    ...
    meta: [
      {
        ...
        name: "All artists",
        content:
          "The list of all the artists partecipating at the Avignon's Festival. It's also possible to click on one of them to know in which events they are involved",
      },
    ],
  },
  components: {
  ...
  data() {
    const pageData = {
      ...
      shortDescription:
        "Getting fascinated by Avignon is easy. The performers are all amazing.",
      description:
