export default async (models) => {
  ...
  const eventList = [
    {
      ...
      description:
        "Open the doors of perception. Singer Barbara Carlotti lends her voice to the Beat Generation, with help from 'sound assembler' Prieur de la Marne, for a journey to the edge of trance. Singer Barbara Carlotti and “sound assembler” Prieur de la Marne celebrate the Beat Generation, the American movement which, during the postwar period and until the 1960s, played a decisive role in art history.",
    ...
    },
    {
      ...
      name: "Moby Dick",
      description:
        "The legend of writer Herman Melville is brought to life in this theatrical rendition of Moby Dick. Screenplay writer and director Yngvild Aspeli [CHECK THIS NAME] creatively uses the stage to take the audience through an emotional and symbolic journey through the ocean to pursue a giant whale.",
    ...
    },
    {
      ...
      description:
        "A passionate jazz oratorio inspired by the odyssey of the great Palestinian poet Mahmoud Darwish, this show about the pain of exile couldnt be more relevant",
  ...
  const artistList = [
    ...
    },
    {
      ...
      description:
        "Harpsichordist Goska Isphording specializes in contemporary music on historical instruments. She is not only active as a soloist and chamber musician, but also presents the contemporary harpsichord to audiences and composers around the world through close collaborations, lectures and masterclasses. Goska's solo appearances include Gaudeamus Music Week or November Music, and more recently Warsaw Autumn Festival, Gaida Festival, ISCM World Music Days and Huddersfield Contemporary Music Festival. Pan-European appearances have brought Goska to the attention of a variety of composers, and her inimitable approach to the harpsichord has earned numerous dedications and commissions. Goska has premiered over a hundred solo and chamber music compositions and is an addressee of harpsichord concerti by Hanna Kulenty, Roderik de Man or Andrzej Kwiecinski. A passion for the careful interplay of apparently disparate forms has led Goska to co-found The Roentgen Connection. She is also a member of The Riot Ensemble in London and has collaborated with ensembles like Asko|Schönberg, Insomnio Ensemble, Musikfabrik or Sinfonia Varsovia.",
    },
    ...
    {
      name: "Kae Tempest",
      img: "https://ilmanifesto.it/_next/image?url=https%3A%2F%2Fstatic.ilmanifesto.it%2F2022%2F06%2F21vis2altrakae-tempest-torino-jazz-festival-2.jpg&w=3840&q=75",
      date_of_birth: "27/06/96",
      description:
    ...
    },
    {
      ...
      date_of_birth: "27/06/96",
      description:
        'Sunnery James & Ryan Marciano is a Dutch DJ and record production duo from Amsterdam, composed of Sunnery Gorré (Sunnery James) and Ryan de Lange (Ryan Marciano).[1] Both DJs are of Surinamese descent. Accustomed to renowned labels, they released "SOTU" in March 2013, collaboration with Nicky Romero, on the label of Steve Angello. The title was a success, ranking as high as #2 on the Beatport Top 100. Soon after, the duo joined Spinnin\' Records, where they signed many singles such as "Triton", "Salute", and more recently "Come Follow". They have since joined the Armada Music family with their own imprint SONO Music. Their music has developed a distinct tribal style to it.',
    },
    {
      name: "Eric Gales",
  ...
  const placesList = [
    {
      ...
      description:
        "The initial opera house was constructed in 1824–1825, and opened with its inaugural performance on 30 October 1825. The original opera house was destroyed in a fire on 26 January 1846.",
    ...
    },
    {
      ...
      caption:
        "It was in the Cour d'Honneur of the Palais des papes that the Festival d'Avignon began in 1947, with William Shakespeare's The Tragedy of King Richard II, directed by Jean Vilar.",
      description:
        "It has long remained the main venue of the Festival. It was only from the mid-1960s that new venues open. These new locations, often historical and seldom dedicated to live performance, offer surprising and original theatrical spaces and give Avignon its personality each summer as a city-theatre.",
    ...
    },
    {
      ...
      caption:
        "The cloister of the Carmelites , located on Place des Carmes and dependent on the conventual church of the Carmelites , is one of the many examples of the convents built in Avignon during the 13th  century .",
      description:
    ...
    },
    {
      ...
      caption:
        "Lycée Saint-Joseph of Avignon is a private Catholic secondary school located in the city of Avignon, Vaucluse, in the Provence-Alpes-Côte d'Azur, France.",
      description:
        "Built in the 19th century by Jesuits on the site of the Cordeliers convent, the lycée Saint-Joseph is a key venue of the Festival d'Avignon. Every summer, its large square courtyard welcomes a large open-air stage with a 750 seating area.",
    ...
    },
    {
      ...
      caption:
        "A modern stage of the Festival d'Avignon designed by Polish architect Maria Godlewska.",
      description:
        "Composed of a hall the size of the stage of the Cour d'honneur, 18 living quarters and 2 adjoining technical spaces, this theatrical “factory” provides a year-round residence for artistic teams working to prepare their next creation for the Festival d'Avignon. This regular presence of artists on the Avignon territory allows the Festival to intensify its work to raise awareness on the performing arts among all audiences.",
  ...
  for (let i = 0; i < allEvents.length; i++) {
    ...
    artistsToIncl.forEach((value) => {
      ...
      models.EventArtist.create({
        eventId: allEvents[i].id,
        artistId: allArtists[value].id,
      });
    });
  }
};
